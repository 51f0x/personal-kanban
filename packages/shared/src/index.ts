...
// ============================================================
// Column Types (Legacy - use Column entity from domain/entities instead)
// ============================================================
...
// Legacy Column interface - kept for backward compatibility
// Use Column entity from domain/entities instead
...
// ============================================================
// Task Types (Legacy - use Task entity from domain/entities instead)
// ============================================================
export type TaskContext = 'EMAIL' | 'MEETING' | 'PHONE' | 'READ' | 'WATCH' | 'DESK' | 'OTHER';

// Legacy Task interface - kept for backward compatibility
// Use Task entity from domain/entities instead
