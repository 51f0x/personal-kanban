...
import { CheckCircle2, Clock, Inbox, AlertTriangle, TrendingUp } from 'lucide-react';
        ...
        <Card className="p-4 border-amber-200 bg-amber-50">
          <div className="flex items-start justify-between">
            <div className="flex-1">
              ...
              <p className="text-2xl font-bold text-amber-900">{wipBreaches.breachingColumns}</p>
