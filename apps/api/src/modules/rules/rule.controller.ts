...
export class RuleController {
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'List rules for board', description: 'Get all rules for a specific board' })
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Create rule', description: 'Create a new rule for a board' })
  @ApiParam({ name: 'boardId', description: 'Board ID' })
  @ApiBody({ type: CreateRuleDto, description: 'Rule data (boardId is taken from URL parameter)' })
  ...
  @Post('rules/validate')
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Validate rule', description: 'Validate a rule without creating it' })
  ...
  @Patch('rules/:id')
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Update rule', description: 'Update an existing rule' })
  @ApiParam({ name: 'id', description: 'Rule ID' })
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Toggle rule', description: 'Enable or disable a rule' })
  @ApiParam({ name: 'id', description: 'Rule ID' })
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Duplicate rule', description: 'Create a copy of an existing rule' })
  @ApiParam({ name: 'id', description: 'Rule ID' })
  @ApiQuery({ name: 'name', required: false, description: 'Name for the duplicated rule' })
