...
export class AgentProgressController {
  ...
  @ApiOperation({
    summary: "Update agent progress",
    description: "Receive agent processing progress updates from worker",
  })
  @ApiBody({
    type: AgentProcessingProgressDto,
    description: "Agent processing progress",
  })
  @ApiResponse({
    status: 200,
  ...
  async updateProgress(
    @Body() progress: AgentProcessingProgress,
