...
export class ColumnController {
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'List columns for board', description: 'Get all columns for a specific board' })
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Get WIP status', description: 'Get work-in-progress status for a board' })
  @ApiParam({ name: 'boardId', description: 'Board ID' })
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Create column', description: 'Create a new column for a board' })
  @ApiParam({ name: 'boardId', description: 'Board ID' })
  @ApiBody({ type: CreateColumnDto, description: 'Column data (boardId is taken from URL parameter)' })
  ...
  @Patch('columns/:id')
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Update column', description: 'Update an existing column' })
  @ApiParam({ name: 'id', description: 'Column ID' })
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Reorder columns', description: 'Reorder columns for a board' })
  @ApiParam({ name: 'boardId', description: 'Board ID' })
