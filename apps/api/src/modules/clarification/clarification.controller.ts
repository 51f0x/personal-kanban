...
export class ClarificationController {
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Get next unclarified task', description: 'Get the next unclarified task from the Input column' })
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Clarify task', description: 'Apply clarification decisions to a task' })
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Get clarification statistics', description: 'Get clarification statistics for a board' })
  @ApiParam({ name: 'boardId', description: 'Board ID' })
