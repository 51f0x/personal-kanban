...
export class UpdateChecklistItemDto {
    @ApiPropertyOptional({ description: 'Checklist item title', example: 'Review documentation' })
    @IsOptional()
    @IsString()
    title?: string;

    @ApiPropertyOptional({ description: 'Whether the checklist item is completed', example: false })
    @IsOptional()
    @IsBoolean()
    isDone?: boolean;
