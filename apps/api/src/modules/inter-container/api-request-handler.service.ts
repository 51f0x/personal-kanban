...
export class ApiRequestHandlerService {
    ...
    private async handleGetUsers(request: GetUsersRequest): Promise<GetUsersResponse> {
    ...
    private async handleGetTasks(request: GetTasksRequest): Promise<GetTasksResponse> {
        const where: any = {};
    ...
    private async handleGetTask(request: GetTaskRequest): Promise<GetTaskResponse> {
    ...
    private async handleGetColumns(request: GetColumnsRequest): Promise<GetColumnsResponse> {
    ...
    private async handleMoveTasks(request: MoveTasksRequest): Promise<MoveTasksResponse> {
