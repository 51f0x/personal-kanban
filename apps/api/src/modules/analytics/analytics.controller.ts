...
export class AnalyticsController {
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Get board summary', description: 'Get summary statistics for a board' })
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Get Cumulative Flow Diagram', description: 'Get CFD data for a board' })
  @ApiParam({ name: 'boardId', description: 'Board ID' })
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Get throughput', description: 'Get throughput data (completed tasks per period)' })
  @ApiParam({ name: 'boardId', description: 'Board ID' })
  @ApiQuery({ name: 'period', required: false, enum: ['day', 'week'], description: 'Period type (default: week)' })
  @ApiQuery({ name: 'periods', required: false, description: 'Number of periods (default: 12)' })
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Get lead and cycle time', description: 'Get lead time and cycle time metrics' })
  @ApiParam({ name: 'boardId', description: 'Board ID' })
  @ApiQuery({ name: 'limit', required: false, description: 'Limit number of tasks (default: 50)' })
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Get WIP breaches', description: 'Get work-in-progress limit breach status' })
  @ApiParam({ name: 'boardId', description: 'Board ID' })
