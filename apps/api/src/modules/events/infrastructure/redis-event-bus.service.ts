import type { DomainEvent, IEventBus } from "@personal-kanban/shared";
import {
  Injectable,
  Logger,
...
export class RedisEventBus implements IEventBus, OnModuleInit, OnModuleDestroy {
  ...
  subscribe<T extends DomainEvent>(
    ...
    this.handlers
      .get(eventName)!
      .add(handler as (event: DomainEvent) => Promise<void> | void);
  ...
  /**
   * Get Redis client (for testing or advanced usage)
   */
