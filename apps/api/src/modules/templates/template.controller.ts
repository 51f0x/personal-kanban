...
export class TemplateController {
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'List templates for board', description: 'Get all templates for a specific board' })
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Create template', description: 'Create a new template for a board' })
  @ApiParam({ name: 'boardId', description: 'Board ID' })
  @ApiBody({ type: CreateTemplateDto, description: 'Template data (boardId is taken from URL parameter)' })
  ...
  @Patch('templates/:id')
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Update template', description: 'Update an existing template' })
  @ApiParam({ name: 'id', description: 'Template ID' })
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Toggle template', description: 'Enable or disable a template' })
  @ApiParam({ name: 'id', description: 'Template ID' })
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Skip next occurrence', description: 'Skip the next scheduled occurrence of a template' })
  @ApiParam({ name: 'id', description: 'Template ID' })
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Run template now', description: 'Execute a template immediately' })
  @ApiParam({ name: 'id', description: 'Template ID' })
  ...
  @Delete('templates/:id')
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Delete template', description: 'Delete a template' })
  @ApiParam({ name: 'id', description: 'Template ID' })
