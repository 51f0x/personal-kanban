...
export class HealthController {
    ...
    @ApiOperation({
        ...
        description: 'Returns 200 if the service is running. Used by container orchestrators.',
    })
    ...
    @ApiOperation({
        ...
        description: 'Checks if the service can handle requests. Used by load balancers.',
    })
