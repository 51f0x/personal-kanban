...
export abstract class BaseAgent {
  ...
  constructor(
    ...
    this.llmTimeoutMs = config.get<number>('LLM_TIMEOUT_MS', 30000); // 30s default
  ...
  protected logError(
    ...
    this.logger.error(`${operation} failed`, error instanceof Error ? error.stack : undefined, logContext);
  }
}
